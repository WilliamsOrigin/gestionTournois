	...
	<div class="page-wrapper chiller-theme toggled">
		...
		<main class="page-container">
			...
			<div class="container-fluid">
				<h2 class="text-left">>> Players list</h2>
				<br />
				<div class="row">
							...
							<div class="card">
								...
								<div class="card-body">
									<h5 class="card-title">${player.getNom() }
										(${player.getNationalite() })</h5>
									<p class="card-text text-justify">
										${player.getDescription() }</p>
								</div>
								<div class="card-footer text-muted">
									<span class="text-warning">Classement Mondial:
										${player.getClassementmondial() }</span>
								</div>
							</div>
						</div>
						<br>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<select name="nationalite" class="form-control" required>
										...
										<option value="Guinee_equatoriale">Guinée équatoriale
										</option>
										...
										<option value="Republique_dominicaine">République
											dominicaine</option>
										<option value="Republique_tcheque">République tchèque
										</option>
										...
										<option value="Saint-Siège">Saint-Siège, ou leVatican
										</option>
										<option value="Saint-Vincent-et-les_Grenadines">
											Saint-Vincent-et-les Grenadines</option>
										<option value="Salomon">Salomon</option>
										<option value="Salvador">Salvador</option>
										<option value="Samoa_occidentales">Samoa occidentales
										</option>
