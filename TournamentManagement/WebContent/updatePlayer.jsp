...
<body>
	...
	<div class="page-wrapper chiller-theme toggled">
		...
		<main class="page-container">
			...
			<div class="container-fluid">
				<h2 class="text-left">>> Edit / Delete a player</h2>
				<div class="row">
					<div class="col-sm-8">
						<%
					...
					<div class="col-sm-12">
						<form action="updatePlayer" method="POST">
							<div class="container">
								<div class="row">
									<div class="col-sm-5">
										<input type="text" name="nom" placeholder="player name"
											class="form-control" value="${player.getNom() }" /> <input
											type="hidden" name="idj" value="${player.getIdJoueur() }" />
									</div>
									<div class="col-sm-4">
										<select name="nationalite" class="form-control">
											...
											<option value="Guinee_equatoriale">Guinée
												équatoriale</option>
											...
											<option value="Republique_dominicaine">République
												dominicaine</option>
											<option value="Republique_tcheque">République
												tchèque</option>
											...
											<option value="Saint-Siège">Saint-Siège, ou
												leVatican</option>
									...
									<div class="col-sm-3">
										<input type="number" name="classementMondial"
											...
											max="100" value="${player.getClassementmondial() }" />
									</div>
								</div>
								<br />
								<div class="row">
			...
			%>
			<br /> <br />
			<h3 class="text-left">>> Update the player picture</h3>
			<div class="row mt-4">
				<div class="col-sm-2">
					<%
						String u_error = (String) request.getAttribute("uploadErr");
						if (u_error != null) {
					%>
					<div class="alert alert-danger" role="alert">
						<button type="button" class="close" data-dismiss="alert"
				...
				<div class="col-sm-8">
					<form method="POST" action="updateImagePlayer"
							...
							<div class="row">
								<div class="col-sm-6 pr-0">
									<input type="hidden" name="idjoueur"
										value="${player.getIdJoueur() }" /> 
									<input type="file"
										name="image" class="form-control form-control-lg" required />
								</div>
	...
	<script>
		new WOW().init();
		alert("For the modification use the search button and find a player by his name!!\n\n and "
				+ "only replace the fields you need let the others empty or unchanged");
	</script>
</body>
</html>
